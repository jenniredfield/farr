      ...
      <div className="relative mx-auto w-full max-w-6xl px-6">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-semibold tracking-tight text-white sm:text-5xl">
            Energy consultancy and compliance handled efficiently.
          </h1>
          <p className="mt-6 text-lg text-secondary-200">
            Farrsited provides energy consultancy and compliance for residential
            and commercial property — SAP calculations, EPCs and on-construction
            assessments for new builds and existing buildings alike.
          </p>
        </div>
      </div>
    </section>
